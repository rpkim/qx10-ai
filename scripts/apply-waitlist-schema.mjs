...
if (!databaseUrl) {
  console.error(
    'Missing DATABASE_URL.\n' +
      ...
      'Or paste db/waitlist-migration.sql into the SQL Editor:\n' +
      '  https://supabase.com/dashboard/project/_/sql/new'
  );
  process.exit(1);
}

const sqlFile = join(root, 'db/waitlist-migration.sql');
